...
const AddBill = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-100 flex justify-center items-center p-4">
            ...
            >
                {billLoading ? <main className="flex-1 bg-white shadow-lg rounded-lg p-6 overflow-scroll flex w-full justify-around">
                ...
                </main> : <div className="flex-1 bg-white shadow-lg rounded-lg p-6 overflow-scroll">
